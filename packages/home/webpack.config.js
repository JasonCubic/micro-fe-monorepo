  ...
  const webpackConfig = {
    ...
    plugins: [
      ...
      new ModuleFederationPlugin({
        ...
        remotes: {
          home: 'home@http://localhost:9090/remoteEntry.js',
          contactUs: 'contactUs@http://localhost:9091/remoteEntry.js',
          team: 'team@http://localhost:9092/remoteEntry.js',
          modal: 'modal@http://localhost:9093/remoteEntry.js',
        },
        exposes: {
